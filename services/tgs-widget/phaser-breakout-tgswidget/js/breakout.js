...
function create() {
    ...
    */
    ...
    replayBtn.visible = false;
     ...
     // Create a wrong orientation image and BG for mobile
    if (!game.device.desktop)
    {   
...
function update () {
    ...
    // Keep the ball glued to the paddle if its not released and reset its animation frame to 0
    if (ballOnPaddle)
    {
