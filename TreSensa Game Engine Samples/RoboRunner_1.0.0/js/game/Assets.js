Assets = function()
{
    ...
    this.locations =  [
        ...
        //UI
        {id:'distance_ui',              url:'ui/distance_ui.png'},  
        {id:'coin_ui',                  url:'ui/coin_ui.png'},
    ...
    this.hudSettings = [];
    this.hudSettings ["distanceHUD"]  = {icon:"distance_ui", height:20, font:"60px myFont", fontColor:"#003760"};
    this.hudSettings ["coinHUD"]      = {icon:"coin_ui",     height:70, font:"60px myFont", fontColor:"#003760"};
